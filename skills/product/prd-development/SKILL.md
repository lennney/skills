...
- **Use:** `problem-statement` (component)
- **Input:** Discovery insights from `discovery-process` or `problem-framing-canvas`
- **Participants:** PM
- **Duration:** 30 minutes
...
- **Use:** `customer-journey-mapping-workshop` output
- **Jobs-to-be-done:** If motivations are key
- **Use:** `jobs-to-be-done` output
...
**1. Document Personas**
- **Use:** `proto-persona` (component) output
- **Participants:** PM
- **Duration:** 30 minutes
...
- **Use:** `tam-sam-som-calculator` (interactive) output
...
- **Use:** `user-story-mapping-workshop` output
...
└─ Phase 4: Strategic Context (45 min)
   └─ Use: tam-sam-som-calculator (optional)
...
└─ Phase 7: User Stories & Requirements (90-120 min)
   ├─ Use: epic-hypothesis
   ├─ Use: epic-breakdown-advisor/SKILL.md
   ├─ Use: user-story
...
**Fix:** Use discovery insights from `discovery-process`; include customer quotes, analytics, support tickets
...
- `customer-journey-mapping-workshop` (interactive, optional)

**Phase 3:**
- `proto-persona` (component)
- `jobs-to-be-done` (component, optional)

**Phase 4:**
- `tam-sam-som-calculator` (interactive, optional)
...
- `epic-breakdown-advisor` (interactive)
